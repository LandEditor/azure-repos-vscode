...
export async function activate(context: ExtensionContext) {
	...
	context.subscriptions.push(
		commands.registerCommand(CommandNames.AssociateWorkItems, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.AssociateWorkItems()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.GetPullRequests, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.GetMyPullRequests()
			)
		)
	);
	context.subscriptions.push(
	...
	context.subscriptions.push(
		commands.registerCommand(CommandNames.Signout, () =>
			_extensionManager.RunCommand(() => _extensionManager.Team.Signout())
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenBlamePage, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenBlamePage()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenBuildSummaryPage, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenBuildSummaryPage()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenFileHistory, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenFileHistory()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenNewBug, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenNewBug()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenNewPullRequest, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenNewPullRequest()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenNewTask, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenNewTask()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenNewWorkItem, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenNewWorkItem()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.OpenTeamSite, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.OpenTeamProjectWebSite()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.ViewWorkItems, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.ViewMyWorkItems()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.ViewPinnedQueryWorkItems, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.ViewPinnedQueryWorkItems()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.ViewWorkItemQueries, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.ViewWorkItems()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.SendFeedback, () =>
			_extensionManager.RunCommand(() => _extensionManager.SendFeedback())
		)
	);
	context.subscriptions.push(
		commands.registerCommand(CommandNames.RefreshPollingStatus, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Team.RefreshPollingStatus()
			)
		)
	);
	context.subscriptions.push(
	...
	// TFVC Commands
	context.subscriptions.push(
		commands.registerCommand(TfvcCommandNames.Delete, (...args) =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Tfvc.Delete(args ? args[0] : undefined)
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(TfvcCommandNames.UndoAll, () =>
			_extensionManager.RunCommand(() => _extensionManager.Tfvc.UndoAll())
		)
	);
	context.subscriptions.push(
	...
	context.subscriptions.push(
		commands.registerCommand(TfvcCommandNames.ResolveKeepYours, (...args) =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Tfvc.Resolve(
					args ? args[0] : undefined,
					AutoResolveType.KeepYours
				)
			)
		)
	);
	...
	context.subscriptions.push(
		commands.registerCommand(TfvcCommandNames.Refresh, () =>
			_extensionManager.RunCommand(() => _extensionManager.Tfvc.Refresh())
		)
	);
	context.subscriptions.push(
		commands.registerCommand(TfvcCommandNames.ShowOutput, () =>
			_extensionManager.RunCommand(() =>
				_extensionManager.Tfvc.ShowOutput()
			)
		)
	);
	context.subscriptions.push(
		commands.registerCommand(TfvcCommandNames.Checkin, () =>
			_extensionManager.RunCommand(() => _extensionManager.Tfvc.Checkin())
		)
	);
	context.subscriptions.push(
