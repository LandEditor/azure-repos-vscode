...
describe("RepoUtils", function () {
	...
	it("should ensure valid Team Foundation Server Git urls", function () {
		...
		url =
			"http://minint-i0lvs2o:8080/tfs/DefaultCollection/_git/GitProject";
		assert.isTrue(RepoUtils.IsTeamFoundationServerRepo(url));
		...
		assert.isTrue(RepoUtils.IsTeamFoundationServerRepo(url));
		url =
			"http://192.168.0.1:8084/sources2010/tfs/DefaultCollection/_git/repo";
		assert.isTrue(RepoUtils.IsTeamFoundationServerRepo(url));
	...
	it("should ensure Azure DevOps Services urls are not valid Team Foundation Server Git urls", function () {
		...
		let url: string;
		url =
			"https://mseng.visualstudio.com/VSOnline/_git/Java.VSCode.CredentialStore";
		assert.isFalse(RepoUtils.IsTeamFoundationServerRepo(url));
		url =
			"https://mseng.visualstudio.com/DefaultCollection/VSOnline/_git/Java.IntelliJ";
		assert.isFalse(RepoUtils.IsTeamFoundationServerRepo(url));
		url =
			"https://test.azure.com/mseng/VSOnline/_git/Java.VSCode.CredentialStore";
		assert.isFalse(RepoUtils.IsTeamFoundationServerRepo(url));
		url = "https://test.azure.com/mseng/VSOnline/_git/Java.IntelliJ";
		assert.isFalse(RepoUtils.IsTeamFoundationServerRepo(url));
		url =
			"ssh://mseng@mseng.visualstudio.com:22/DefaultCollection/VSOnline/_git/Java.IntelliJ/";
		assert.isFalse(RepoUtils.IsTeamFoundationServerRepo(url));
	...
	it("should ensure valid Azure Repos Git urls", function () {
		...
		url =
			"ssh://acctname@vs-ssh.visualstudio.com:22/DefaultCollection/_ssh/reponame";
		assert.isTrue(RepoUtils.IsTeamFoundationServicesRepo(url));
		url = "git@ssh.mytest.azure.com:v3/account/project/repository";
		assert.isTrue(RepoUtils.IsTeamFoundationServicesRepo(url));
	...
	it("should ensure Azure DevOps Services URLs on visualstudio.com domain are not valid Azure DevOps Services Git URLs on azure.com domain", function () {
		...
		assert.isFalse(RepoUtils.IsTeamFoundationServicesAzureRepo(url));
		url =
			"https://mseng.visualstudio.com/azure.com/azure.com/_git/azure.com";
		assert.isFalse(RepoUtils.IsTeamFoundationServicesAzureRepo(url));
	});
	...
	it("should ensure valid Team Foundation Git urls", function () {
		...
		url =
			"https://account.visualstudio.com/DefaultCollection/VSOnline/_git/Java.IntelliJ";
		assert.isTrue(RepoUtils.IsTeamFoundationGitRepo(url));
	...
	it("should allow any other url as a valid Team Foundation repository", function () {
		...
		url =
			"git@github.com:Microsoft/Git-Credential-Manager-for-Mac-and-Linux.git";
		assert.isTrue(
			RepoUtils.IsTeamFoundationServerRepo(url),
			"GitHub SSH url is not detected as a valid Azure DevOps Services repo"
		);
		...
		assert.isTrue(
			RepoUtils.IsTeamFoundationServerRepo(url),
			"GitHub url is not detected as a valid Azure DevOps Services repo"
		);
		...
		assert.isTrue(
			RepoUtils.IsTeamFoundationServerRepo(url),
			"foo url is not detected as a valid Azure DevOps Services repo"
		);
	});
	...
	it("should detect a valid Azure DevOps Services repository but not as a Git repository", function () {
		...
		url =
			"https://account.visualstudio.com/DefaultCollection/VSOnline/Java.IntelliJ";
		assert.isTrue(
			RepoUtils.IsTeamFoundationServicesRepo(url),
			"Java.IntelliJ url is not detected as a valid Azure DevOps Services repo"
		);
		assert.isFalse(
			RepoUtils.IsTeamFoundationGitRepo(url),
			"Java.IntelliJ url is  detected as a valid Git repo"
		);
	...
	it("should convert V3 ssh url to git url", function () {
		...
		url = "git@ssh.mytest.azure.com:v3/account/project/repository";
		assert.equal(
			RepoUtils.ConvertSshV3ToUrl(url),
			"https://mytest.azure.com/account/project/_git/repository"
		);
		url = "git@vs-ssh.visualstudio.com:v3/account/project/repository";
		assert.equal(
			RepoUtils.ConvertSshV3ToUrl(url),
			"https://account.visualstudio.com/project/_git/repository"
		);
	});
});
