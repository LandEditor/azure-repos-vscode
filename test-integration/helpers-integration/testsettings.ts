...
export class TestSettings {
	...
	public static get RemoteRepositoryUrl(): string {
		const remoteRepositoryUrl: string =
			process.env.MSVSTS_TEAM_REMOTE_REPOSITORY_URL;
	...
	public static get RemoteTfvcRepositoryUrl(): string {
		const remoteRepositoryUrl: string =
			process.env.MSVSTS_TEAM_REMOTE_TFVC_REPOSITORY_URL;
	...
	public static get WorkItemQueryId(): string {
		const workItemQueryId: string =
			process.env.MSVSTS_TEAM_WORK_ITEM_QUERY_ID;

		return workItemQueryId || "undefined-workitem-query-id";
	}

	public static get WorkItemLinkQueryPath(): string {
		const workItemQueryPath: string =
			process.env.MSVSTS_TEAM_WORK_ITEM_LINK_QUERY_PATH;
	...
	public static get WorkItemQueryPath(): string {
		const workItemQueryPath: string =
			process.env.MSVSTS_TEAM_WORK_ITEM_QUERY_PATH;
	...
	public static get WorkItemTwoHundredTasksQueryPath(): string {
		const workItemQueryPath: string =
			process.env.MSVSTS_TEAM_WORK_ITEM_TWO_HUNDRED_QUERY_PATH;

		return (
			workItemQueryPath || "undefined-workitem-twohundredtasks-query-path"
		);
	}

	public static get WorkItemZeroResultsQueryPath(): string {
		const workItemQueryPath: string =
			process.env.MSVSTS_TEAM_WORK_ITEM_ZERO_RESULTS_QUERY_PATH;
	...
	public static get ProjectGuid(): string {
		const remoteRepositoryUrl: string =
			process.env.MSVSTS_TEAM_PROJECT_GUID;
	...
	public static get CollectionGuid(): string {
		const remoteRepositoryUrl: string =
			process.env.MSVSTS_TEAM_COLLECTION_GUID;
